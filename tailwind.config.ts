...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        mesh: "radial-gradient(at 40% 20%, hsl(var(--primary) / 0.08) 0px, transparent 50%), radial-gradient(at 80% 0%, hsl(var(--accent) / 0.12) 0px, transparent 50%), radial-gradient(at 0% 50%, hsl(var(--muted) / 0.3) 0px, transparent 50%)",
      },
      boxShadow: {
